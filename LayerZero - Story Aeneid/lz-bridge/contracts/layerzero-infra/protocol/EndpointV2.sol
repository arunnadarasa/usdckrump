...
/**
 * @title LayerZero EndpointV2
 * @notice Core messaging endpoint for LayerZero V2 protocol on Story Aeneid
 * @dev Deployed for USDC Dance cross-chain bridge infrastructure
 * 
 * @custom:deployment Story Aeneid Testnet (Chain ID: 1315, EID: 1315)

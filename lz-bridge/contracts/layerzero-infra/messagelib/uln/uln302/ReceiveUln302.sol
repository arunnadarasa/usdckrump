...
/**
 * @title ReceiveUln302 - Ultra Light Node Receive Library
 * @notice LayerZero V2 receive-side message library for Story Aeneid
 * @dev Handles inbound cross-chain message verification and delivery
 * 
 * @custom:deployment Story Aeneid Testnet

 ...
 *
 * Usage:
 *   PRIVATE_KEY=<attester_key> node scripts/relayer-bridge.js
 *   or
 *   BRIDGE_ATTESTER_KEY=<attester_key> node scripts/relayer-bridge.js
 *
...
async function main() {
  ...
  const attesterKey = process.env.BRIDGE_ATTESTER_KEY || process.env.PRIVATE_KEY;
  if (!attesterKey) {

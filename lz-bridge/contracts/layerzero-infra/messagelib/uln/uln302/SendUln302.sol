...
/**
 * @title SendUln302 - Ultra Light Node Send Library
 * @notice LayerZero V2 send-side message library for Story Aeneid
 * @dev Handles outbound cross-chain message sending with ULN verification
 * 
